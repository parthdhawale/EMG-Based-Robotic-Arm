...
#define FINGER1 1 //Based on EMG sensor placement on the left hand
#define FINGER2 2
#define FINGER3 3
#define FINGER4 4
#define FINGER5 5
...
// You have to rewrite properly the functions to open and close the fingers according of your assembly FINGER3 and FINGER4 fingers are opened when servo is at 170 degrees and the others when servo is at 0 degrees
...
void loop() {// Nothing to do here, all is done in the interrupt function
  ...
  if(value>THRESHOLD) //If the value of the sample is greater than THRESHOLD means that the hand has been closed
      ...
      {openhand();}
  Serial.println(value); //You can use serial monitor to set THRESHOLD properly, compaFINGER2 the values shown when you open and close your hand
}
